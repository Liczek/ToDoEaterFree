...
//    }
    ...
    func configureColors() {
        //green
        if UserDefaults.standard.integer(forKey: "ActualColorOfApplication") == 0 {
            ...
            //red
        } else if UserDefaults.standard.integer(forKey: "ActualColorOfApplication") == 1 {
            ...
            self.universalTextColor = UIColor.black
            //blue
        } else if UserDefaults.standard.integer(forKey: "ActualColorOfApplication") == 2 {
